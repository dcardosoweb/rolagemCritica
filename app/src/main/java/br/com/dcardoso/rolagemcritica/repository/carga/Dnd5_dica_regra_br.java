    ...
    public static DicaDeRegra[] populateData() {
        return new DicaDeRegra[]{
                new DicaDeRegra(
                        ...
                        TipoSistemaEnum.DungeonsDragons.getValor(), IdiomaEnum.Portugues.getValor()),
                new DicaDeRegra(
                        "DISADVANTAGE",
                        "Desvantagem",
                ...
                new DicaDeRegra(
                        ...
                        "O personagem recebe penalidade em: <ul> <li> Verificações de sabedoria </ li> <li> Testes de economia de sabedoria </ li> <li> Testes de manejo de animais, insights, medicina, percepção e sobrevivência </ li>  <li> Testes de Vontade </ li> <li> Magias baseadas em Sabedoria </ li> </ ul>",
                        TipoSistemaEnum.DungeonsDragons.getValor(),IdiomaEnum.Portugues.getValor()),
                new DicaDeRegra(
                        "ABILITY-CHA",
                        "Redução de carisma",
